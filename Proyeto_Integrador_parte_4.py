#PARTE 4 del proyecto integrador
...
print(f'{nombre_de_usuario} el juego esta por comenzar, preparate.')
nombre_de_usuario = input('Enter para comenzar...')
...
print(f'{nombre_de_usuario} felicidades por terminar el juego.')
